...
void adregistr()
{
    ...
    {
        if(v.adday<=31 && v.admonth <= 12 && 1900<= v.adyear && v.adyear <= 2021 )
        {
            system("CLS");
            printf("                                        '''''''''''''''''''''''''''''                       \n");
...
void adchng_user()
{
    ...
    if(strcmp(u,v.aduser)==0 && strcmp(p,v.adpass)==0)
    {
        ...
        scanf("%s",&v.aduser);
        fwrite(&v, sizeof(v),1,adf);
        printf("\n\n\n\t\t\t\t____USERNAME CHANGE SUCCESSFULLY____");
        fclose(adf);
        getch();
        system("CLS");
        adgeneral();
...
void adchng_pass()
{
    ...
    if(strcmp(u,v.aduser)==0 && strcmp(p,v.adpass)==0)
    {
        ...
        scanf("%s",&v.adpass);
        fwrite(&v, sizeof(v),1,adf);
        printf("\n\n\n\t\t\t\t____PASSWORD CHANGE SUCCESSFULLY____");
        fclose(adf);
        getch();
        system("CLS");
        adgeneral();
...
savingfile(char TI[],char DT[],char com[],char PA[],int A[],int j,int tk,int k,char FD[],char FC[])
{
    ...
    fprintf(file,"\t\t\t\tSIT NO         : %d",tx[tt].a);

    fprintf(file,"\n\n\t\t\t\tPASSENGER NAME    : %s %s\n",tx[tt].fn2,tx[tt].ln2);
    fprintf(file,"\t\t\t\t(PASSPORT/NID) NO : %s \n",tx[tt].pass2);
    fprintf(file,"\t\t\t\tGENDER            : %s \n",tx[tt].gen2);
    fprintf(file,"\t\t\t\tSIT NO         : %d",tx[tt].b);

    fprintf(file,"\n\n\t\t\t\tPASSENGER NAME    : %s %s\n",tx[tt].fn3,tx[tt].ln3);
    fprintf(file,"\t\t\t\t(PASSPORT/NID) NO : %s \n",tx[tt].pass3);
    fprintf(file,"\t\t\t\tGENDER            : %s \n",tx[tt].gen3);
    fprintf(file,"\t\t\t\tSIT NO         : %d",tx[tt].c);
    t=tk*j;
...
viewing()
{
    ...
    printf("\t\t\t\t 5.VIEW ROOT\n");
    printf("\t\t\t\t 6.VIEW TICKET HISTORY \n");
    printf("\t\t\t\t 7.VIEW TICKET BY CODE \n");
    printf("\t\t\t\t 8.VIEW CARGO COMPANY\n");
    printf("\t\t\t\t 9.VIEW PASSENGER DESTINATION \n");
    printf("\t\t\t\t 10.VIEW PASSENGER FLIGHTS \n");
    printf("\t\t\t\t 11.VIEW CHARTER  FLIGHTS \n");
    printf("\t\t\t\t 12.VIEW PASSENGER PROFILE \n");
    printf("\t\t\t\t 13.<-- \n\n");
    printf("\n\t\t\t\t\t ENTER YOUR CHOICE:");
    scanf("%d",&n);
    if(n==1)
...
adding()
{
    ...
    printf("\t\t\t\t 6.ADD CARGO COMPANY\n");
    printf("\t\t\t\t 7.ADD CHARTER FACILITIES\n");
    printf("\t\t\t\t 8.ADD FLIGHTS DESTINATION\n");
    printf("\t\t\t\t 9.ADD CHARTER FLIGHTS\n");
    printf("\t\t\t\t 10.<--\n");
    printf("\t\t\t\t ENTER YOUR CHOICE :");
    scanf("%d",&n);
    if(n==1)
...
editing()
{
    ...
    printf("\t\t\t\t 6.EDIT FLIGHTS ROOT\n");
    printf("\t\t\t\t 7.EDIT CHARTER FACILITIES\n");
    printf("\t\t\t\t 8.EDIT DESTINATION\n");
    printf("\t\t\t\t 9.EDIT CHARTER FLIGHTS\n");
    printf("\t\t\t\t10.<--\n");
    printf("\t\t\t\t\t ENTER YOUR CHOICE :");
    scanf("%d",&n);
    if(n==1)
...
tupgr()
{
    if(tx[tt].HMT>=3)
    {
        printf("YOU CANT BUY MORE TICKET FROM THIS ACCOUNT \n");
        usleep(900000);
        user();
    }
    else
...
deleteaccount()
{
    ...
    else
    {
        ...
        if(ch==1)
        {
            ...
            v.adyear=0;
            fwrite(&v, sizeof(v), 1, adf);
            printf("\n\n\t\t\t\t\t_____ ACCOUNT DELECTED SUCCESSFULLY _____");
            fclose(adf);
            getch();
            admin();
        }
