...
admin()
{
    ...
    for(i=0; i<j; i++)
    {
        ...
        l=rand()%1000;
        printf("\n\t\t\t\tPROVED THAT YOU NOT A ROBOT . ENTER THE VIEWING CODE....\n\n");
        sleep(1);
        printf("\t\t\t\t\t Code is: %d",l);
...
editcompany()
{
    ...
    printf("WHICH COMPANY DO YOU WANT TO EDIT >> ");
    scanf("%d",&j);
    printf("NEW NAME>>");
    //fgets(&b[j].comn, sizeof(b[j].comn), stdin);
    scanf("%s",&b[j].comn);
}
edittime()
{
...
passenger()
{
    ...
    printf("ENTER YOURT FAVORITE FLIGHTS >>");
    scanf("%d",&ac);
