...
aboutus()
{
    char ch1[60]=" BANGLADESH UNIVERCITY OF BUSINESS AND TECHNOLOGY\n\n";
    char ch2[50]=" PROJECT : BLACK PANDA \n";
    char ch3[50]=" PROJECT TOPIC : AIRLINES TICKETS SELLING ";
    char ch4[50]=" COURSE TEACHER : MEER MUTTAKIN ALAM ";
    char ch5[50]=" \t\t\t TEAM : 01 ";
    char ch6[80]="  LEADER : ANUPAM KUMAR \n\t\t\t\t ID : 19202103261 \n\t\t\t\t MOBILE NO : 01736181068 ";
    char ch7[80]="  MEMBER 01 : MD. AL EMAM \n\t\t\t\t ID : 19202103242 \n\t\t\t\t MOBILE NO : ";
    char ch8[80]="  MEMBER 02 : FARHAN ISRAQ \n\t\t\t\t ID : 19202103272 \n\t\t\t\t MOBILE NO : 01744227109";
    system("CLS");
    printf("\n\n\n\t\t\t\t");
    for(int i=1; i<=55; i++)
    {
...
mac()
{
    fileMC=fopen("informationmac.txt","w");
    def.company;
    def.patime;
    def.pafood;
    def.pafaci;
