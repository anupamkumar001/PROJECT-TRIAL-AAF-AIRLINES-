...
viewfile(); // for view
savingfile(char TI[],char DT[],char com[],char PA[],int A[],int j,int tk,int k);
...
savingfile(char TI[],char DT[],char com[],char PA[],int A[],int j,int tk,int k) //for save
{
...
B737_8(char TI[],char DT[],char com[],int n,int tk) //plane 01 20
{
    ...
    getch();
    savingfile(TI,DT,com,B737_8,A,j,tk,k);

}
B777_3(char TI[],char DT[],char com[],int n,int tk) //plane 02 36
{
    ...
    getch();
    savingfile(TI,DT,com,B777_3,A,j,tk,k);

}
B787_8(char TI[],char DT[],char com[],int n,int tk) //plane 03 8
{
    ...
    getch();
    savingfile(TI,DT,com,B787_8,A,j,tk,k);

}
B787_9(char TI[],char DT[],char com[],int n,int tk) //plane 04 48
{
    ...
    getch();
    savingfile(TI,DT,com,B787_9,A,j,tk,k);

}
BD8Q_4(char TI[],char DT[],char com[],int n,int tk) //plane 05 24
{
    ...
    getch();
    savingfile(TI,DT,com,BD8Q_4,A,j,tk,k);
